package com.example.pemrograman_mobile.pertemuan12;
...
public class AdapterCatatan extends BaseAdapter {

    private List<PojoCatatan> sgd;
    private Context context;
    private int id;
    private AlertDialog daftarCatatan;

    public AdapterCatatan(List<PojoCatatan> sgd, Context context, AlertDialog daftarCatatan) {
        this.sgd = sgd;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        final PojoCatatan setterGetterData = sgd.get(position);
        ...
        itemJudul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, MainCatatan.class);
