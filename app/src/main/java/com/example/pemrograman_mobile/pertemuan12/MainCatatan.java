...
public class MainCatatan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpanCatatan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PojoCatatan sgd = new PojoCatatan();
    ...
    private void dialogDaftarCatatan () {
        ...
        AdapterCatatan adapterDaftarCatatan = new AdapterCatatan(setterGetterData, getApplicationContext(),
                daftarCatatan);
