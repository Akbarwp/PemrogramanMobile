...
public class PojoTv implements Parcelable {
    ...
    public static final Creator<PojoTv> CREATOR = new Creator<PojoTv>() {
        @Override
        public PojoTv createFromParcel(Parcel in) {
            return new PojoTv(in);
        }

        @Override
        public PojoTv[] newArray(int size) {
            return new PojoTv[size];
        }
    };
